...
| Adaptive safety reduces hard safety cost below numerical tolerance in the 5-seed main scenarios. | `results/week13_14_experiments/week13_main_summary.csv`; `results/week15_16_experiments/week16_confidence_intervals.csv` | Supported |
