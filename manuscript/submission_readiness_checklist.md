...
|---|---|---|
| Full article draft | Complete first draft in Markdown | Convert to Word/LaTeX template if required |
| Abstract length | Main draft revised to 234 words | Recheck after final edits; limit is 250 words |
...
| Figures | Existing PNG/PDF/SVG/TIFF exports | Select final panels and polish labels |
| Tables | Sources identified | Convert result CSVs into compact manuscript tables |
| References | Placeholders only | Verify and format every citation |
| Data availability | Draft statement included | Confirm source-data license and redistribution terms |
