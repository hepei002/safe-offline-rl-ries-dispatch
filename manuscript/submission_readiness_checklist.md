...
|---|---|---|
| Full article draft | LaTeX manuscript prepared | Replace repository DOI/accession after archival |
...
| Data availability | GitHub repository inserted; DOI application in progress | Add persistent release DOI/accession after archival |
| Generative AI declaration | Draft statement included | Align with Elsevier's current wording |
| Funding statement | Added to manuscript and submission materials | Confirm grant wording and grant-holder attribution |
| CRediT statement | Draft added to manuscript and submission materials | Confirm roles with all authors before submission |
| Competing interests | No competing interests draft added | Confirm with all authors before submission |
